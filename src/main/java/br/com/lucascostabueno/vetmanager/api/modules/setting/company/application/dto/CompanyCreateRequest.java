...
public record CompanyCreateRequest(@NotBlank(message="O nome fantasia é obrigatório")@Size(max=100,message="O nome fantasia deve ter no máximo 100 caracteres")String company,
